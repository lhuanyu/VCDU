...
class CDUDisplayLineView: UIView {
    ...
    private lazy var labelLS:UILabel! = { [unowned self] in
    ...
    private lazy var labelS:UILabel! = { [unowned self] in
    ...
    private lazy var labelRS:UILabel! = { [unowned self] in
    ...
    private lazy var labelLT: UILabel = { [unowned self] in
    ...
    private lazy var labelT: UILabel = { [unowned self] in
    ...
    private lazy var labelRT: UILabel = { [unowned self] in
